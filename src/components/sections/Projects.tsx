                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100">
                    ...
                    {project.live && (
                      <a
                        ...
                        className="px-6 py-3 bg-linear-to-br from-accent to-purple-600 text-white font-bold rounded-xl flex items-center gap-2 hover:shadow-2xl hover:shadow-accent/50 transition-all duration-300 transform hover:scale-110 backdrop-blur-sm"
                      >
                    ...
                    {project.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-6 py-3 bg-background/80 border-2 border-white text-white font-bold rounded-xl flex items-center gap-2 hover:border-accent hover:bg-accent/20 transition-all duration-300 transform hover:scale-110 backdrop-blur-sm"
                      >
